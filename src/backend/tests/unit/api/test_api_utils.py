...
from all-ai.api.utils import get_suggestion_message
from all-ai.services.database.models.flow.utils import get_outdated_components
...
def test_get_outdated_components():
    ...
    with patch(
        "all-ai.services.database.models.flow.utils.get_components_versions", return_value=mock_component_versions
    ):
