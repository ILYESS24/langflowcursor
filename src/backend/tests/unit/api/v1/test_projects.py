...
class TestProjectMCPIntegration:
    ...
    def mock_mcp_settings_enabled(self):
        ...
        with patch("all-ai.api.v1.projects.get_settings_service") as mock_get_settings:
    ...
    async def test_create_project_with_mcp_auto_add_enabled_success(
        ...
        with (
            patch("all-ai.api.v1.projects.get_settings_service") as mock_get_settings,
            patch("all-ai.api.v1.projects.get_project_sse_url") as mock_sse_url,
            patch("all-ai.api.v1.projects.validate_mcp_server_for_project") as mock_validate,
            patch("all-ai.api.v1.projects.update_server") as mock_update_server,
            patch("all-ai.api.v1.projects.create_api_key") as mock_create_api_key,
            patch("all-ai.api.v1.projects.get_storage_service") as mock_storage,
        ):
            # Setup mocks
    ...
    async def test_update_project_name_with_mcp_server_update(
        ...
        with (
            patch("all-ai.api.v1.projects.get_settings_service") as mock_get_settings,
            patch("all-ai.api.v1.projects.get_project_sse_url"),
            patch("all-ai.api.v1.projects.validate_mcp_server_for_project") as mock_validate_create,
            patch("all-ai.api.v1.projects.update_server"),
            patch("all-ai.api.v1.projects.create_api_key"),
            patch("all-ai.api.v1.projects.get_storage_service"),
        ):
            # Mock settings to enable MCP auto-add
            mock_settings = MagicMock()
            mock_settings.settings.add_projects_to_mcp_servers = True
    ...
    async def test_create_project_auto_login_disabled_adds_api_key_auth(
        ...
        with patch("all-ai.api.v1.projects.get_settings_service") as mock_get_settings:
            ...
            with patch("all-ai.api.v1.projects.encrypt_auth_settings") as mock_encrypt:
