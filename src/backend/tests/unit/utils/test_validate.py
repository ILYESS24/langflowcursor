...
from lfx.custom.validate import (
    _create_all_ai_execution_context,
    add_type_ignores,
...
class TestCreateLangflowExecutionContext:
    """Test cases for _create_all_ai_execution_context function."""

    def test_creates_context_with_all_ai_imports(self):
        """Test that context includes ALL AI imports."""
        # The function imports modules inside try/except blocks
        # We don't need to patch anything, just test it works
        context = _create_all_ai_execution_context()
    ...
    def test_does_not_include_pandas(self):
        """Test that pandas is not included in the ALL AI execution context."""
        context = _create_all_ai_execution_context()
...
"""
    ...
    def test_replaces_legacy_imports(self):
        ...
        code = """
from ALL AI import CustomComponent
...
class TestGetDefaultImports:
    ...
    def test_includes_all_ai_imports(self):
        """Test that ALL AI imports are included when found in code."""
