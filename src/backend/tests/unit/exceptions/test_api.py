...
from all-ai.exceptions.api import APIException, ExceptionBody
...
def test_api_exception():
    ...
    with (
        patch(
            "all-ai.services.database.models.flow.utils.get_outdated_components",
            return_value=mock_outdated_components,
        ),
        patch("all-ai.api.utils.get_suggestion_message", return_value=mock_suggestion_message),
        patch(
            "all-ai.services.database.models.flow.utils.get_components_versions",
