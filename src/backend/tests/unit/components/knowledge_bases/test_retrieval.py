...
from all-ai.components.knowledge_bases.retrieval import KnowledgeRetrievalComponent
...
class TestKnowledgeRetrievalComponent(ComponentTestBaseWithClient):
    ...
    def mock_knowledge_base_path(self, tmp_path):
        ...
        with patch("all-ai.components.knowledge_bases.retrieval.KNOWLEDGE_BASES_ROOT_PATH", tmp_path):
            yield
    ...
    def test_get_kb_metadata_success(self, component_class, default_kwargs, active_user):
        ...
        with patch("all-ai.components.knowledge_bases.retrieval.decrypt_api_key") as mock_decrypt:
