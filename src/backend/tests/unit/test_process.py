...
from all-ai.services.deps import get_session_service
from all-ai.services.utils import register_all_service_factories
...
def test_apply_tweaks_code_override_prevention():
    ...
    from all-ai.processing.process import apply_tweaks
    ...
    # Capture log output
    with patch("all-ai.processing.process.logger") as mock_logger:
