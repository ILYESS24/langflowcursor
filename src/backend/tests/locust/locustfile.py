...
class FlowRunUser(FastHttpUser):
    """FlowRunUser simulates users sending requests to the ALL AI run endpoint.
    ...
    Environment Variables:
      - LANGFLOW_HOST: Base URL for the ALL AI server (default: http://localhost:7860)
    ...
    def run_flow_endpoint(self):
        ...
        payload = {
            "input_value": (
                "Hey, Could you check https://docs.allai.org for me? Later, could you calculate 1390 / 192 ?"
            ),
            "output_type": "chat",
            "input_type": "chat",
            "tweaks": {},
