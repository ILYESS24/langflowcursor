declare module 'styled-components' {
  ...
  export function styled<T extends keyof JSX.IntrinsicElements>(
    tag: T
  ): (strings: TemplateStringsArray, ...interpolations: any[]) => ComponentType<JSX.IntrinsicElements[T] & StyledComponentProps>;

  export function styled<T extends ComponentType<any>>(
    component: T
  ): (strings: TemplateStringsArray, ...interpolations: any[]) => ComponentType<React.ComponentProps<T> & StyledComponentProps>;
