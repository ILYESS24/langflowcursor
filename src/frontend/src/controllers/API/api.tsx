  ...
  useEffect(() => {
    ...
    const isAuthorizedURL = (url) => {
      const authorizedDomains = [
        "https://raw.githubusercontent.com/all-ai-ai/all_ai_examples/main/examples",
        "https://api.github.com/repos/all-ai-ai/all_ai_examples/contents/examples",
        "https://api.github.com/repos/all-ai-ai/ALL AI",
        "auto_login",
      ];
