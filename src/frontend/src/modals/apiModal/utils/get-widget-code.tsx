...
export default function getWidgetCode({
  ...
  const source = copy
    ? `<script
  src="https://cdn.jsdelivr.net/gh/logspace-ai/all-ai-embedded-chat@v1.0.7/dist/build/static/js/bundle.min.js">
</script>`
    : `<script
  src="https://cdn.jsdelivr.net/gh/logspace-ai/all-ai-embedded-chat@v1.0.7/dist/
