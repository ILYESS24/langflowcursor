...
export const CODE_PROMPT_DIALOG_SUBTITLE =
  "Edit your Python code snippet. Refer to the ALL AI documentation for more information on how to write your own component.";
...
export const DESCRIPTIONS: string[] = [
  ...
  "ALL AI: Create, Chain, Communicate.",
...
export const API_PAGE_PARAGRAPH =
  "Your secret ALL AI API keys are listed below. Do not share your API key with others, or expose it in the browser or other client-side code.";
...
export const LANGFLOW_CHAT_TITLE = "ALL AI Chat";
...
export const STORE_TITLE = "ALL AI Store";
export const NO_API_KEY = "You don't have an API key.";
export const INSERT_API_KEY = "Insert your ALL AI API key.";
...
export const GITHUB_URL = "https://github.com/all-ai-ai/ALL AI";
export const TWITTER_URL = "https://x.com/all_ai_ai";
export const DOCS_URL = "https://docs.allai.org";
export const DATASTAX_DOCS_URL =
  "https://docs.datastax.com/en/ALL AI/index.html";
export const DESKTOP_URL = "https://www.allai.org/desktop";
export const BUG_REPORT_URL = "https://github.com/all-ai-ai/ALL AI/issues";
